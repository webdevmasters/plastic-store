...
<div id="error408">
    <h1><span>4</span>
        <svg preserveAspectRatio="xMidYMid" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
            <circle cx="50" cy="50" fill="none" r="40" stroke="#1B1B1B" stroke-dasharray="60 60" stroke-linecap="round" stroke-width="8">
                <animateTransform attributeName="transform" begin="0s" calcMode="linear" dur="1.5s" keyTimes="0;1" repeatCount="indefinite" type="rotate" values="0 50 50;360 50 50"></animateTransform>
            </circle>
            <circle cx="50" cy="50" fill="none" r="30" stroke="#222222" stroke-dasharray="50 50" stroke-dashoffset="50" stroke-linecap="round" stroke-width="8">
                <animateTransform attributeName="transform" begin="0s" calcMode="linear" dur="1.5s" keyTimes="0;1" repeatCount="indefinite" type="rotate" values="0 50 50;-360 50 50"></animateTransform>
            </circle>
        </svg>
        <span>8</span>
